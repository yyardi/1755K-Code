...
bool isPark = false; //Park Pneumatics
...
void autonomous(void) {
  ...
  MyDrive.turnFor(right, 37/2.95, degrees);
  Intake.spin(fwd, 100, pct);
  MyDrive.driveFor(5, inches);
  wait(600, msec);
  MyDrive.driveFor(-6, inches);
  MyDrive.turnFor(left, 18/2.90, degrees);
  MyDrive.driveFor(-32, inches);
  Intake.stop(brake);
  MyDrive.turnFor(right, 93/2.8, degrees);
  //Descore
  MyDrive.driveFor(-4, inches);
  Wings.set(true);
  MyDrive.driveFor(5, inches);
  MyDrive.turnFor(left, 15, degrees);
  
  MyDrive.driveFor(16, inches);
